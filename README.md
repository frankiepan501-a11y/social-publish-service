...
- 2026-07-15 FB/IG card closure hardening:
  ...
  - Verification: n8n readback confirmed weekly/approval reply nodes contain PATCH-original-card logic and no longer send plain-text receipts, while daily-confirm and KOL reply nodes still retain PATCH logic. Local `unittest discover -s tests` passed 98 tests with service-token env cleared for local auth.
